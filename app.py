...
template_question = "Generate FAQ Schema in microdata format for the following questions and answers: '{}'"
...
def main():
    ...
    system_message = "FAQ Schema Generator in microdata format"
